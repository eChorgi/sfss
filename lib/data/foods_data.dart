...
List<FoodData> foodDatas = [
  FoodData(index:0, name:'苦瓜', describe:'苦瓜富含维生素C和维生素B1、B2等B族维生素，具有抗氧化作用，能增强免疫力，促进胶原蛋白的合成，维持神经系统的正常功能和新陈代谢的稳定。', history:'苦瓜，古名锦荔枝，也称癞瓜。其性喜温，耐湿不耐寒，原产于印度，后传入中国。《救荒本草》记载其为明代朱所录，距今已六百余年。苦瓜不传己苦与他物，故有“君子菜”之称。其味苦，却有清心明目之效，古人亦有诗赞之：“口苦能写偈，心清志方操。”', lastTasted:DateTime.now(), tasteCount:1, myRank:4, globalRank:4.2),
